...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.post_list = function () {
        return this.http.get(this.API_URL + 'posts');
    };
    // send a POST request to the API to create a new data object
    ApiService.prototype.post_create = function (post) {
    ...
    // send a POST request to the API to create a new data object
    ApiService.prototype.user_create = function (user) {
...
/* harmony import */ var _userprofile_userprofile_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./userprofile/userprofile.component */ "./src/app/userprofile/userprofile.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"]],
...
var RegistrationComponent = /** @class */ (function () {
    function RegistrationComponent(_apiService) {
    ...
    RegistrationComponent.prototype.createUser = function () {
        var _this = this;
        this._apiService.user_create(this.new_user).subscribe(function (data) {
            _this.getUsers();
            return true;
        }, function (error) {
...
var UserprofileComponent = /** @class */ (function () {
    function UserprofileComponent(_apiService) {
        this._apiService = _apiService;
    }
    ...
    UserprofileComponent.prototype.createPost = function () {
        var _this = this;
        this._apiService.post_create(this.new_post).subscribe(function (data) {
            // refresh the list
            _this.getPosts();
            return true;
        }, function (error) {
